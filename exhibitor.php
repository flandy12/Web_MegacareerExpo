                        ...
                        <div class="input-group">
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select name="txtevent">
                                    ...
                                    <option>Career Expo Surabaya, 25-26 Januari 2023 - DBL Arena </option>
                                    <option>Mega Career Expo Jakarta, 24-25 Februari 2023 - SMESCO Exhibition Hall</option>
                                    <option>Career Expo     , 5-6 Mei 2023 - Pendopo USU</option>
                                </select>
