...
<head>
  ...
  $result = mysqli_query($mysqli, "SELECT * FROM header");
  ?>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                while ($header = mysqli_fetch_array($result)) {
                  ?>
                    <tr>
                    <td><img src="../../../<?php echo $header['foto_header'] ?>" style="height:100px;width:100px;"></td>
                    <td><a href='deleteheader.php?id=<?php echo $header['id_header'] ?>'>Delete</a></td>
                <?php 
                }
                ?>
                ...
                <div class="modal fade" id="form_modal" tabindex="-1" role="dialog" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <form action="../../../save_header.php" method="POST" enctype="multipart/form-data">
