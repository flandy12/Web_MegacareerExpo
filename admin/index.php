...
<head>
  ...
  $result = mysqli_query($koneksi, "SELECT * FROM tbupcomingevent");
  ?>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="pages/tables/accept.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="pages/tables/medpar.php" class="nav-link">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Medpar
              </p>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                while ($qryupcoming = mysqli_fetch_array($result)) {
                  ?>
                    <tr>
                    <td><?php echo $qryupcoming['nama_upcoming'] ?></td>
                    <td><img src="../<?php echo $qryupcoming['foto_upcoming'] ?>" style="height:100px;width:100px;"></td>
                    <td><a href='delete.php?id=<?php echo $qryupcoming['id_upcoming'] ?>'>Delete</a></td>
                <?php 
                }
                ?>
