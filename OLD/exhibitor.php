...
<html lang="en">
  <head>
    ...
    <!--====== CSS TABLE =======-->
    <!-- Icons font CSS-->
    <link href="js/tablejs/mdi-font/css/material-design-iconic-font.min.css" rel="stylesheet" media="all">
    <link href="js/tablejs/font-awesome-4.7/css/font-awesome.min.css" rel="stylesheet" media="all">
    <!-- Font special for pages-->
    <link href="https://fonts.googleapis.com/css?family=Roboto:100,100i,300,300i,400,400i,500,500i,700,700i,900,900i" rel="stylesheet">

    <!-- Vendor CSS-->
    <link href="js/tablejs/select2/select2.min.css" rel="stylesheet" media="all">
    <link href="js/tablejs/datepicker/daterangepicker.css" rel="stylesheet" media="all">

    <!-- Main CSS-->
    <link href="css/tablecss/main.css" rel="stylesheet" media="all">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="exhibitor.php">Exhibitor
...
<!-- Footer -->
    ...
    <!-- Jquery JS-->
    <script src="js/tablejs/jquery/jquery.min.js"></script>
    <!-- Vendor JS-->
    <script src="js/tablejs/select2/select2.min.js"></script>
    <script src="js/tablejs/datepicker/moment.min.js"></script>
    <script src="js/tablejs/datepicker/daterangepicker.js"></script>
